...
![Mocha the Calico Maine Coon is shown in multiple positions. On the left they stand casually wearing a full outfit. On the right there are A-pose unclothed front and back shots to show their fur colours and patterns. Below that are their colour pallet swatches. At the bottom there is a bust of them pulling a silly pose.](../public/img/ref-sheet-example.png)
...
![A collection of images annotated with notes explaining what from the image to use and how. There are accessories, a species ref, a colour pallet, a pose and a hair style.](../public/img/annotated-collage-example.png)
